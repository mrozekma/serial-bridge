<template>
    <div>
        ...
        <div class="body">
            ...
            If easier, you can also enter the path to the application here to generate a registry file:
            <form method="post" action="/generate-reg">
                <input type="text" name="telnet_path" value="C:\Program Files (x86)\PuTTY\putty.exe">
